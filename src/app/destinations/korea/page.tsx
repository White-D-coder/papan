      ...
      <div style={{ height: "70vh", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "absolute", bottom: 80, left: "8%", right: "8%", zIndex: 10 }}>
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }}>
            <p style={{ fontFamily: "var(--font-mono)", fontSize: 12, letterSpacing: "0.25em", color: "#B24C35", marginBottom: 16 }}>SEOUL, THIS AUTUMN</p>
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.4 }} style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: 80 }}>
          ...
          <div>
            <div style={{ marginBottom: 48 }}>
              ...
              <p style={{ fontFamily: "var(--font-display)", fontSize: 24, fontWeight: 600 }}>OCT '26</p>
            </div>
            <div>
          ...
          <div>
            ...
            <p style={{ fontSize: 20, lineHeight: 1.8, color: "#4A5568", fontFamily: "Georgia, serif" }}>
              Vibrant cityscapes, historical palaces, and the undeniable energy of autumn in Seoul. From quiet tea houses to bustling street food markets, discover the heart of Korea.
            </p>
