...
const TIPS = [
  ["01", "IC CARDS", "Use an IC card for trains, buses and everyday purchases.", "/images/japan/tokyo.jpg"],
  ["02", "TRAINS", "Build your route around train lines instead of crossing the city repeatedly.", "/images/japan/osaka.jpg"],
  ["03", "CASH", "Keep some yen for smaller shops and places that do not accept cards.", "/images/japan/kyoto.jpg"],
  ["04", "INTERNET", "A reliable eSIM makes navigation much easier.", "/images/japan/cinema-1.jpg"],
  ["05", "ETIQUETTE", "Keep your voice low on trains and follow local signs.", "/images/japan/hotel-kyoto.jpg"],
  ["06", "MAPS", "Save important locations before leaving your hotel.", "/images/japan/spring.jpg"],
];
    ...
    >
      <div className="container">
        ...
        <div className="section-heading">
          ...
          <p>
            Practical details that make
            the difference between a
            stressful trip and a smooth one.
          </p>
        </div>

        <div className="tips-grid">
          {TIPS.map(
            ([number, title, text, image], index) => {
                  ...
                  <AnimatePresence>
                    {isHovered && (
                      ...
                      >
                        ...
                        <div className="tip-hover-tag">{number}</div>
                      </motion.div>
                    )}
                  </AnimatePresence>
                </motion.article>
